...
vim.keymap.set('n', '<leader>gj', git.nav_hunk, { desc = 'Next Hunk' })
vim.keymap.set('n', '<leader>gk', git.nav_hunk, { desc = 'Prev Hunk' })
...
vim.keymap.set('n', '<leader>gu', git.stage_hunk, { desc = 'Undo Stage Hunk' })
